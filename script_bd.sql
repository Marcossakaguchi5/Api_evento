...
use fatecEventos;
INSERT INTO usuario (login,email,senha,telefone,perfil) VALUES ("nivea","nivea@fsnt.com","nivea","1456859632","adm");
INSERT INTO usuario (login,email,senha,telefone,perfil) VALUES ("elvis","elvis@fsnt.com","elvis","1485963256","adm");
INSERT INTO usuario (login,email,senha,telefone,perfil) VALUES ("carla","carla@jacto.com","carla","1425365689","usuario");
SELECT * FROM usuario;
...
VALUES('2022-07-27','formatura bdag 2022/2','1');
INSERT INTO evento (data_hora,descricao,id_login) 
VALUES('2023-01-23','Formaturha map 2022/2','2');
INSERT INTO evento (data_hora,descricao,id_login) 
VALUES('2024-02-25','Formaturha bdag 2023/1','1');
SELECT * FROM evento;

INSERT INTO convidados (nome,email,cargo,telefone,id_empresa)
VALUES ('Marcos Hideki','marcosHideki@Ciag.com','PesquisadorIII','14958362518',1);
INSERT INTO convidados (nome,email,cargo,telefone,id_empresa)
VALUES ('Giovana ','Giovana@jacto.com','Designer pleno','1536259876',1);
INSERT INTO convidados (nome,email,cargo,telefone,id_empresa)
VALUES ('Lucas Cabrera ','lucasCabrera@jacto.com','Front-End Pleno','1736259856',1);
